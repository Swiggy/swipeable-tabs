...
declare const _default: React.NamedExoticComponent<SwipeViewProps>;
...
export declare const TabHeader: ({ index, onClick, width, label, isSelected }: {
    index: any;
    onClick: any;
    width: any;
    label: any;
...
declare const Tab: React.FC<Pick<TabProps, "label">>;
export default Tab;
...
declare const _default: React.NamedExoticComponent<TabGroupProps>;
export default _default;
